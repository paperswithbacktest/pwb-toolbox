...
class TestFeatureClusters(unittest.TestCase):
    ...
    def test_get_feature_clusters(self):
        ...
        clustered_subsets_ha = get_feature_clusters(
            self.X,
        ...
        self.X["R_5c"] = self.X[
            "R_5"
        ]  # this feature is add to introduce low DF in the regressor.
        self.X["R_1c"] = self.X[
            "R_1"
        ]  # this will trigger the expection of LinAlgError i.e. presence of singular matrix
