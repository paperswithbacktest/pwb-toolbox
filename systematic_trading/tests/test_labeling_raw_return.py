...
class TestLabelingRawReturns(unittest.TestCase):
    ...
    def test_resample(self):
        ...
        test6 = raw_return(
            price1, binary=False, logarithmic=True, resample_by="W", lag=True
        )
        test7 = raw_return(
            price2, binary=False, logarithmic=False, resample_by="Y", lag=True
        )
        test8 = raw_return(
            price2, binary=True, logarithmic=False, resample_by="Y", lag=True
        )
