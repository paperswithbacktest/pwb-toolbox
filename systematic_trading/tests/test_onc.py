...
from systematic_trading.clustering import get_onc_clusters
from systematic_trading.clustering.onc import _check_improve_clusters
...
class TestOptimalNumberOfClusters(unittest.TestCase):
    ...
    def test_get_onc_clusters(self):
        ...
        self.assertTrue(
            self._check_if_in_cluster([11, 14, 18], clusters)
        )  # Check clusters components
        self.assertTrue(
            self._check_if_in_cluster([0, 2, 3, 10, 12, 13, 20, 22, 23], clusters)
        )
