...
class TestLabelingOverMean(unittest.TestCase):
    ...
    def test_large_set(self):
        ...
        pd.testing.assert_series_equal(
            test3, test3_actual, check_less_precise=True, check_names=False
        )
    ...
    def test_resample_period(self):
        ...
        test5_actual = pd.DataFrame(
            {
                "EEM": [0.017255, -0.042112, 0.004907, 0.016267, -0.026054, np.nan],
        ...
        test6_actual = pd.DataFrame(
            {
                "EEM": [np.nan, 0.018196, -0.027718, 0.047210, 0.001358],
