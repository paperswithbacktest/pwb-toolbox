...
def bet_size_reserve(
    ...
    Note that this function creates a <systematic_trading.bet_sizing.ef3m.M2N> object and makes use of the parallel fitting
    functionality. As such, this function accepts and passes fitting parameters to the
    systematic_trading.bet_sizing.ef3m.M2N.mp_fit() method.
