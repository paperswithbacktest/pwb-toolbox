...
from systematic_trading.sampling.concurrent import (
    num_concurrent_events,
    get_av_uniqueness_from_triple_barrier,
)
from systematic_trading.util.multiprocess import mp_pandas_obj
...
def get_weights_by_time_decay(
    triple_barrier_events, close_series, num_threads=5, decay=1, verbose=True
):
    """
