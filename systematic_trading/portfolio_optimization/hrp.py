...
class HierarchicalRiskParity:
    ...
    def allocate(
        ...
        covariance_matrix = pd.DataFrame(
            covariance_matrix, index=asset_names, columns=asset_names
        )
        ...
        distance_matrix = pd.DataFrame(
            distance_matrix, index=asset_names, columns=asset_names
        )
        ...
        self.seriated_distances, self.seriated_correlations = self._get_seriated_matrix(
            assets=asset_names, distance=distance_matrix, correlation=correlation_matrix
        )
